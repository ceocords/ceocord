...
import { Command, FluxEvents } from "@ceocord/discord-types";
...
export interface PluginDef {
    ...
    /**
     * Allows you to add custom actions to the CeoCord Toolbox.
     *
...
export const enum StartAt {
    /** Right away, as soon as CeoCord initialised */
    Init = "Init",
...
> {
    /** Shorthand for `CeoCord.Settings.plugins.PluginName`, but with typings */
    store: SettingsStore<Def> & PrivateSettings;
    /** Shorthand for `CeoCord.PlainSettings.plugins.PluginName`, but with typings */
