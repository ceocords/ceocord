...
export const CspPolicies: PolicyMap = {
    ...
    "cdn.discordapp.com": ImageAndCssSrc, // Discord CDN, used by CeoCord and some themes to load media
    "media.discordapp.net": ImageSrc, // Discord media CDN, possible alternative to Discord CDN

    // CDNs used for some things by CeoCord.
    ...
    // Function Specific
    "api.github.com": ConnectSrc, // used for updating CeoCord itself
    "ws.audioscrobbler.com": ConnectSrc, // Last.fm API
    "translate-pa.googleapis.com": ConnectSrc, // Google Translate API
    "*.CeoCord.dev": ImageSrc, // VenCloud (api.CeoCord.dev) and Badges (badges.CeoCord.dev)
...
const patchCsp = (headers: PolicyMap) => {
    ...
    if (header) {
        ...
        // we could make unsafe-inline safe by using strict-dynamic with a random nonce on our CeoCord loader script https://content-security-policy.com/strict-dynamic/
        ...
        for (const directive of ["style-src", "connect-src", "img-src", "font-src", "media-src", "worker-src"]) {
            pushDirective(directive, "blob:", "data:", "ceocord:", "vesktop:");
        }
