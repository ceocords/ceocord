...
import * as t from "@ceocord/discord-types";
...
export const Forms = {
    ...
    /** @deprecated use Heading from "../CeoCord" */
    FormTitle: Heading,
    /** @deprecated use Paragraph from "../CeoCord" */
    FormText: Paragraph,
...
/** @deprecated use Paragraph, Span, or BaseText from "../CeoCord" */
export const Text = TextCompat;
/** @deprecated use Button from "../CeoCord" */
export const Button = ButtonCompat;
/** @deprecated Use FormSwitch from "../CeoCord" */
export const Switch = FormSwitchCompat as never;

/** @deprecated Use Card from "../CeoCord" */
...
/** @deprecated import from @ceocord/components */
