...
import { CommandArgument, CommandContext, CommandOption } from "@ceocord/discord-types";

import { sendBotMessage } from "./commandHelpers";
import { CeoCordCommand } from "./types";

export * from "./commandHelpers";
export * from "./types";

export let BUILT_IN: CeoCordCommand[];
export const commands = {} as Record<string, CeoCordCommand>;
...
export const _init = function (cmds: CeoCordCommand[]) {
    try {
        BUILT_IN = cmds;
...
export const _handleCommand = function (cmd: CeoCordCommand, args: CommandArgument[], ctx: CommandContext) {
 ...
 * @param opt
 */
export function prepareOption<O extends CommandOption | CeoCordCommand>(opt: O): O {
...
// investigate
function registerSubCommands(cmd: CeoCordCommand, plugin: string) {
...
export function registerCommand<C extends CeoCordCommand>(command: C, plugin: string) {
    if (!BUILT_IN) {
        console.warn(
            "[CommandsAPI]",
