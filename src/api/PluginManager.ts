...
import { FluxEvents } from "@ceocord/discord-types";
...
export function addPatch(newPatch: Omit<Patch, "plugin">, pluginName: string, pluginPath = `CeoCord.Plugins.plugins[${JSON.stringify(pluginName)}]`) {
