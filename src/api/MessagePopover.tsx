...
import { Channel, Message } from "@ceocord/discord-types";
...
function CeoCordPopoverButtons(props: { Component: React.ComponentType<MessagePopoverButtonItem>, message: Message; }) {
