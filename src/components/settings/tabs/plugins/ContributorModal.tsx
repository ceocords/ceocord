...
import { User } from "@ceocord/discord-types";
...
function ContributorModal({ user }: { user: User; }) {
    ...
    const ContributedHyperLink = <Link href="https://CeoCord.dev/source">contributed</Link>;
    ...
    return (
        <>
            ...
            {plugins.length ? (
                ...
                <Forms.FormText>
                    This person has not made any plugins. They likely {ContributedHyperLink} to CeoCord in other ways!
                </Forms.FormText>
            )}
