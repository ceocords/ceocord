    ...
    return (
        <section className={Margins.top16}>
            ...
            <Forms.FormText className={Margins.bottom8}>
                Settings for Notifications sent by CeoCord.
    ...
    return (
        <div style={{ padding: "1em 0" }}>
            ...
            <Forms.FormText className={Margins.bottom8}>
                ...
                <ul>
                    <li><strong>CeoCord Notifications</strong>: These are in-app notifications</li>
            ...
            <Select
                ...
                options={[
                    ...
                    { label: "Always use CeoCord notifications", value: "never" },
