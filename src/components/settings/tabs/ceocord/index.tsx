...
import { gitRemote } from "@shared/ceocordUserAgent";
        ...
        <SettingsTab>
            {isDonor(user?.id)
                ...
                : (
                    <SpecialCard
                        ...
                        description="Please consider supporting the development of CeoCord by donating!"
            ...
            {isPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to CeoCord you now have a cool new badge!"
            ...
            <section>
                ...
                <QuickActionCard>
                    ...
                    <QuickAction
                        Icon={PaintbrushIcon}
                        text="Edit QuickCSS"
                        action={() => CeoCordNative.quickCss.openEditor()}
                    />
                    {!IS_WEB && (
                        <>
                            <QuickAction
                            ...
                            <QuickAction
                                ...
                                action={() => CeoCordNative.settings.openFolder()}
                            />
                        </>
                    )}
                    <QuickAction
                        ...
                        action={() => CeoCordNative.native.openExternal("https://github.com/" + gitRemote)}
                    />
                </QuickActionCard>
            </section>
            ...
            <section className={Margins.top16}>
                ...
                <Forms.FormText className={Margins.bottom20} style={{ color: "var(--text-muted)" }}>
                    ...
                    <a onClick={() => openPluginModal(CeoCord.Plugins.plugins.Settings)}>
...
export default wrapTab(CeoCordSettings, "CeoCord Settings");
