...
async function onFileUpload(e: SyntheticEvent<HTMLInputElement>) {
    ...
    const uploads = Array.from(files, file => {
        ...
        return new Promise<void>((resolve, reject) => {
            ...
            reader.onload = () => {
                CeoCordNative.themes.uploadTheme(name, reader.result as string)
                    .then(resolve)
                    .catch(reject);
            };
...
export function LocalThemesTab() {
    ...
    async function refreshLocalThemes() {
        const themes = await CeoCordNative.themes.getThemesList();
                        ...
                        {IS_WEB ?
                            (
                                ...
                                <QuickAction
                                    ...
                                    action={() => CeoCordNative.themes.openFolder()}
                                    Icon={FolderIcon}
                                />
                            )}
                        <QuickAction
                    ...
                    {userThemes?.map(theme => (
                        <ThemeCard
                            ...
                            onDelete={async () => {
                                ...
                                await CeoCordNative.themes.deleteTheme(theme.fileName);
                                refreshLocalThemes();
                            }}
                            theme={theme}
                        />
