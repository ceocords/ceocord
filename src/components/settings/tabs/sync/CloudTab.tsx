    ...
    return (
        <section>
            ...
            <Paragraph size="md" className={Margins.bottom20}>
                CeoCord comes with a cloud integration that adds goodies like settings sync across devices.
                It <Link href="https://CeoCord.dev/cloud/privacy">respects your privacy</Link>, and
                the <Link href="https://github.com/CeoCord/Backend">source code</Link> is AGPL 3.0 licensed so you
        ...
        <section>
            ...
            <Flex flexDirection="column" gap="1em">
                <FormSwitch
                    ...
                    description="Save your CeoCord settings to the cloud so you can easily keep them the same on all your devices"
                ...
                <div>
                    ...
                    <Select
                        ...
                        isSelected={v => v === localStorage.CeoCord_cloudSyncDirection}
                        serialize={v => String(v)}
                        select={v => {
                            localStorage.CeoCord_cloudSyncDirection = v;
                        }}
                        closeOnSelect={true}
                    />
                </div>
