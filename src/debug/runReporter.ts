...
async function runReporter() {
    ...
    try {
        ...
        addPatch({
            ...
            replacement: {
                match: /(?<="use strict";)/,
                replace: "CeoCord.Webpack._initReporter();"
            }
        }, "CeoCord Reporter");

        // @ts-expect-error
        CeoCord.Webpack._initReporter = function () {
...
// Run after the CeoCord object has been created.
// We need to add extra properties to it, and it is only created after all of CeoCord code has ran
