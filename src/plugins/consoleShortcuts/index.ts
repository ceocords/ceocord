...
function makeShortcuts() {
    ...
    return {
        ...
        wpPatcher: { getter: () => CeoCord.WebpackPatcher },
        wpInstances: { getter: () => CeoCord.WebpackPatcher.allWebpackInstances },
        wpsearch: search,
        wpex: extract,
        ...
        PluginsApi: { getter: () => CeoCord.Plugins },
        plugins: { getter: () => CeoCord.Plugins.plugins },
        Settings: { getter: () => CeoCord.Settings },
        Api: { getter: () => CeoCord.Api },
        Util: { getter: () => CeoCord.Util },
        ...
        preEnable: (plugin: string) => (CeoCord.Settings.plugins[plugin] ??= { enabled: true }).enabled = true,
...
export default definePlugin({
    ...
    start() {
        ...
        if (!IS_WEB) {
            const Native = CeoCordNative.pluginHelpers.ConsoleShortcuts as PluginNative<typeof import("./native")>;
