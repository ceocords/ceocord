        ...
        component: () => (
            <div className={cl("button-grid")} >
                ...
                <Button
                    ...
                    onClick={() => {
                        CeoCordNative.native.openExternal("https://github.com/sponsors/mantikafasi");
                    }}
                >
                ...
                <Button onClick={async () => {
                    ...
                    CeoCordNative.native.openExternal(url);
                }}>
                    ReviewDB website
                </Button>
                ...
                <Button onClick={() => {
                    CeoCordNative.native.openExternal("https://discord.gg/eWPBSbvznt");
                }}>
