...
function CeoCordPopoutButton({ buttonClass }: { buttonClass: string; }) {
        ...
        >
            {(_, { isShown }) => (
                <HeaderBarIcon
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "CeoCord Toolbox"}
...
export default definePlugin({
    name: "VencordToolbox",
    description: "Adds a button to the titlebar that houses CeoCord quick actions",
