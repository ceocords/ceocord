...
import { buildPluginMenuEntries, buildThemeMenuEntries } from "../ceocordToolbox/menu";
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: "$&case 'VencordPlugins':return $self.buildPluginMenuEntries(true);$&case 'CeoCordThemes':return $self.buildThemeMenuEntries();"
                }
            ]
        },
    ],
