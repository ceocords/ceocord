...
const ContributorBadge: ProfileBadge = {
    description: "CeoCord Contributor",
...
async function loadBadges(noCache = false) {
    ...
    DonorBadges = await fetch("https://badges.CeoCord.dev/badges.json", init)
        .then(r => r.json());
}
            ...
            onClick() {
                const modalKey = openModal(props => (
                    <ErrorBoundary noop onError={() => {
                        closeModal(modalKey);
                        CeoCordNative.native.openExternal("https://github.com/sponsors/Vendicated");
                    }}>
                        <ModalRoot {...props}>
                            <ModalHeader>
                                <Forms.FormTitle
                            ...
                            <ModalContent>
                                ...
                                <div style={{ padding: "1em" }}>
                                    <Forms.FormText>
                                        This Badge is a special perk for CeoCord Donors
                                    </Forms.FormText>
                                    <Forms.FormText className={Margins.top20}>
                                        Please consider supporting the development of CeoCord by becoming a donor. It would mean a lot!!
                                    </Forms.FormText>
                                </div>
                            </ModalContent>
                            <ModalFooter>
