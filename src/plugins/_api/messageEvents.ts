    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: (match, args) => "" +
                    `async ${match}` +
                    `if(await CeoCord.Api.MessageEvents._handlePreEdit(${args}))` +
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: (m, parsedMessage, channel, replyOptions, extra) => m +
                    `if(await CeoCord.Api.MessageEvents._handlePreSend(${channel}.id,${parsedMessage},${extra},${replyOptions}))` +
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: (m, message, channel, event) =>
                    `const vcMsg=${message},vcChan=${channel};${m}CeoCord.Api.MessageEvents._handleClick(vcMsg,vcChan,${event});`
            }
        }
    ]
});
