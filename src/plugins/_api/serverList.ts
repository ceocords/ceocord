    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: "[$1].concat(CeoCord.Api.ServerList.renderAll(CeoCord.Api.ServerList.ServerListRenderPosition.Above))"
            }
        },
        {
            find: ".setGuildsTree(",
            replacement: {
                ...
                replace: "CeoCord.Api.ServerList.renderAll(CeoCord.Api.ServerList.ServerListRenderPosition.In).concat($&)"
            }
        }
    ]
});
