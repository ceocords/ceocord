...
import type { Channel, Embed, GuildMember, MessageAttachment, User } from "@ceocord/discord-types";
...
const Native = CeoCordNative.pluginHelpers.XSOverlay as PluginNative<typeof import("./native")>;
