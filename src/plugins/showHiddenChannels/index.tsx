...
import type { Channel, Role } from "@ceocord/discord-types";
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: (m, channel, permCheck) => `${m}!CeoCord.Webpack.Common.PermissionStore.can(${CONNECT}n,${channel})?${permCheck}CONNECT):`
                },
                {
