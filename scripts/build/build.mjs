...
const sourceMapFooter = s => watch ? "" : `//# sourceMappingURL=CeoCord://${s}.js.map`;
...
const buildConfigs = ([
    // Discord Desktop main & renderer & preload
    {
        ...
        footer: { js: "//# sourceURL=file:///CeoCordPatcher\n" + sourceMapFooter("patcher") },
        sourcemap,
        plugins: [
    ...
    {
        ...commonOpts,
        entryPoints: ["src/CeoCord.ts"],
        outfile: "dist/renderer.js",
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///CeoCordRenderer\n" + sourceMapFooter("renderer") },
        globalName: "CeoCord",
        sourcemap,
        plugins: [
    ...
    },
    {
        ...
        footer: { js: "//# sourceURL=file:///CeoCordPreload\n" + sourceMapFooter("preload") },
        sourcemap,
        define: {
            ...defines,
            IS_DISCORD_DESKTOP: "true",
    ...
    // CeoCord Desktop main & renderer & preload
    {
        ...nodeCommonOpts,
        entryPoints: ["src/main/index.ts"],
        outfile: "dist/CeoCordDesktopMain.js",
        footer: { js: "//# sourceURL=file:///CeoCordDesktopMain\n" + sourceMapFooter("CeoCordDesktopMain") },
        sourcemap,
        plugins: [
            ...nodeCommonOpts.plugins,
            globNativesPlugin
    ...
    },
    {
        ...commonOpts,
        entryPoints: ["src/CeoCord.ts"],
        outfile: "dist/CeoCordDesktopRenderer.js",
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///CeoCordDesktopRenderer\n" + sourceMapFooter("CeoCordDesktopRenderer") },
        globalName: "CeoCord",
        sourcemap,
        plugins: [
            globPlugins("vesktop"),
    ...
    },
    {
        ...nodeCommonOpts,
        entryPoints: ["src/preload.ts"],
        outfile: "dist/CeoCordDesktopPreload.js",
        footer: { js: "//# sourceURL=file:///CeoCordPreload\n" + sourceMapFooter("CeoCordDesktopPreload") },
        sourcemap,
        define: {
            ...defines,
            IS_DISCORD_DESKTOP: "false",
